...
function addGamesToPage(games) {
  ...
  for (let i = 0; i < games.length; i++) {
    ...
    gameCard.innerHTML = `
            ...
            <p class="game-details">Backers: ${games[
              i
            ].backers.toLocaleString()}</p>
            <p class="game-details">Pledged: $${games[
              i
            ].pledged.toLocaleString()}</p>
  ...
  //   console.log(GAMES_JSON[0].image);
  //   console.log("Games JSON:", GAMES_JSON); // Check if data is loaded
  //   console.log("Games Container:", gamesContainer); // Check if container exists
}
...
const unfundedString = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${numUnfundedGames} games remain unfunded. We need your help to fund these amazing games!`;
